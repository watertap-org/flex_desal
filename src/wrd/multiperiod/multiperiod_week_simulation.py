...
def build_wrd_flowsheet(
    ...
    def eq_acc_water_prod(b):
        return (
            b.fs.acc_production == b.fs.pre_acc_production + b.fs.total_water_production
        )
    ...
    def eq_acc_energy(b):
        return (
            b.fs.acc_energy
            == b.fs.pre_acc_energy
            + b.fs.total_water_production * b.fs.treatment_energy_per_m3
        )
    ...
    def eq_grid_cost(b):
        return (
            b.fs.grid_cost
            == elec_price * b.fs.total_water_production * b.fs.treatment_energy_per_m3
        )
...
if __name__ == "__main__":
    ...
    total_water_production_target = (
        12 * pyunits.m**3 / pyunits.day * n_days * pyunits.day
    )
